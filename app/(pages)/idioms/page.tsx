...
const IdiomsPage: React.FC = () => {
  ...
  // Auto-play when selected idiom changes
  useEffect(() => {
    if (voiceSettings.autoPlay && selectedIdiom && !isSpeaking) {
  ...
  }, [selectedIdiom, voiceSettings.autoPlay]);
  ...
  // Get the best voice based on priority settings
  ...
  // Function to play the idiom pronunciation with settings
  const playIdiomSound = () => {
    ...
    // Apply preferred voice based on priority
  ...
  const nextIdiom = () => {
    stopPronunciation();
    const currentIndex = displayedIdioms.findIndex(
      (i) => i.idiom === selectedIdiom?.idiom,
    );
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex gap-2">
              ...
              >
                <span
                  className={`inline-block transition-transform ${diceRolling ? "animate-dice-roll" : ""}`}
                >
                  🎲
                </span>
          ...
          <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 flex items-center justify-center">
            <div className="bg-white rounded-2xl p-8 shadow-2xl text-center border-t-4 border-[#f74697]">
              ...
              <div className="text-gray-500">
                تصادفی کردن تجربه یادگیری شما...
              </div>
              <div className="mt-4 flex justify-center gap-1">
                <div
                  className="w-2 h-2 rounded-full animate-pulse"
                  style={{ backgroundColor: "#f74697" }}
                ></div>
                <div
          ...
          <div className="bg-white rounded-2xl shadow-xl p-4 border-t-4 border-[#f74697]">
            <div className="flex justify-between items-center mb-4 pb-2 border-b border-[#ffe073]/30">
              ...
              <span className="text-sm text-gray-500">
                {displayedIdioms.length} اصطلاحات
              </span>
            </div>
            ...
            <div className="p-4 max-h-150 overflow-y-scroll flex flex-col gap-3 overflow-x-hidden">
              {displayedIdioms.map((idiom, index) => (
                ...
                >
                  ...
                  <div
                    className={`text-sm text-right ${selectedIdiom?.idiom === idiom.idiom ? "text-pink-100" : "text-gray-500"}`}
                  >
                    {idiom.persian}
                  </div>
                </button>
